...
const FOOD_MENU_ITEMS = [
  ...
  {
    item: "Gajar Ka Halwa",
    description: "Slow-cooked carrot pudding with milk & dry fruits.",
    price: "$7.95",
    category: FOOD_MENU_CATEGORIES.DESSERTS,
  },
  {
  ...
  {
    item: "Mango Shrikhand",
    description:
      "Thick strained yogurt dessert flavored with mango & cardamom.",
    price: "$6.95",
    category: FOOD_MENU_CATEGORIES.DESSERTS,
  },
  {
    item: "Phirni",
    description: "Ground rice pudding set in earthen pots with saffron & nuts.",
    price: "$7.25",
    category: FOOD_MENU_CATEGORIES.DESSERTS,
  },
  {
    item: "Sandesh",
    description: "Bengali delicacy made with fresh paneer & cardamom.",
    price: "$6.95",
    category: FOOD_MENU_CATEGORIES.DESSERTS,
  },
  {
    item: "Malpua with Rabri",
    description: "Sweet pancakes served with thickened sweet milk.",
    price: "$8.95",
    category: FOOD_MENU_CATEGORIES.DESSERTS,
  },
];
...
export const MenuHighlights = () => {
  const [currentCategory, setCurrentCategory] = useState(
    FOOD_MENU_CATEGORIES.APPETIZERS
  );

  const foodItems = useMemo(
    () => FOOD_MENU_ITEMS.filter((item) => item.category === currentCategory),
    [currentCategory]
  );
    ...
    <section id={styles.menu_highlights}>
      ...
      >
        ...
        <div className={styles.menu_categories_container}>
          {Object.values(FOOD_MENU_CATEGORIES).map((category, index) => {
            return (
              <Button
